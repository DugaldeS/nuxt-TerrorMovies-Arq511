...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<h3 style="${ssrRenderStyle({ "margin-top": "15px" })}">Informacion de peliculas</h3><p>Esta seccion presenta la informacion de las peliculas</p><ul>`);
  _push(ssrRenderComponent(_component_ContentList, { path: "/peliculas" }, {
    default: withCtx(({ list }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<!--[-->`);
        ssrRenderList(list, (pelicula) => {
          _push2(`<li${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`${ssrInterpolate(pelicula.titulo)}`);
              } else {
                return [
        ...
        return [
          (openBlock(true), createBlock(Fragment, null, renderList(list, (pelicula) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/peliculas_index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const peliculas_index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { peliculas_index as default };
//# sourceMappingURL=peliculas_index.22e27548.mjs.map
